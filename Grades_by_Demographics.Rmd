...
if(show_GPA_excluding_DF) print(htmltools::tagList(girafe(ggobj = plot_success))) else print(htmltools::tagList(girafe(ggobj = plot))) # Use htmltools::tagList() to generate multiple interactive plots # results = 'asis' must go in {}
                                                
if(show_GPA_excluding_DF) print(table_success) else print(htmltools::tagList(table))
